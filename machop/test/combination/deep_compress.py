...
from chop.passes.graph.interface.save_and_load import save_mase_graph_interface_pass, save_state_dict_ckpt
...
save_mase_graph_interface_pass(mg, pass_args=pruned_model_save_path)
# ---------------------------------------------------- #
#                   QUANTIZATION                       #
# ---------------------------------------------------- #
...
save_mase_graph_interface_pass(mg, pass_args=quantized_model_save_path)
# ---------------------------------------------------- #
#                   HUFFMAN ENCODING                   #
# ---------------------------------------------------- #
